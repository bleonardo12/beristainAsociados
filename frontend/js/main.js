...
import { initAnalytics, initRemarketing } from './modules/analytics.js'; // Analytics, tracking y remarketing
...
class App {
  constructor() {
    ...
    this.components = [
      ...
      { name: 'remarketing', priority: 'high', init: initRemarketing }, // Remarketing para retargeting
